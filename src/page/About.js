                ...
                <Header/>
                    <div className="container mb-5">
                        <div className="row pt-3 pb-3 bg-transparent">
                            <div className="col-md-2 info pt-4 mb-3">
                                <center>
                                <img src={require('../assets/img/lovebird.png')} className="img-responsive" height="75" />  
                                </center>
                            </div>
                            <div className="col-md-7 pt-4 info text-justify">
                        ...
                        <div className="row pt-3 pb-3 bg-transparent">
                            <div className="col-md-2 mt-4 info">
                                <center>
                                <img src={require('../assets/img/bar-chart (1).png')}/>  
                                </center>
                            </div>
                            <div className="col-md-7 pt-4 info text-justify">
                        ...
                        <div className="row pt-3 pb-3 bg-transparent">
                            <div className="col-md-2 mt-5 info text-justify">
                                <center>
                                <img src={require('../assets/img/girl.png')} height="100" />  
                                </center>
                            </div>
                            <div className="col-md-7 pt-4 info text-justify">
