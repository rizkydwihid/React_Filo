                ...
                <div className="container register-form mt-5">
                    <div className="form">
                        <div className="note couns-img mt-5">
                            ...
                            <span style={{ color: "#476678", fontWeight: "bold", fontSize: '20px' }}>Daftar Sebagai User</span>
                        </div>
                        ...
                        <div className="form-content">
                            <form onSubmit={event => event.preventDefault()}>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-3">
                                        <div className="form-group">
                                            <input type="text" className="form-control" placeholder="Email Kerabat" name="emergencyEmail" required onChange={e => this.props.setField(e)} />
                                        </div>
                                    </div>
                                </div>
                                <div className="row">
                                    ...
                                    <div className="col-md-3">
                                        <div className="form-group">
                                            <input type="text" className="form-control" placeholder="Nomor Handphone" name="phone" required onChange={e => this.props.setField(e)} />
                                        </div>
                                    </div>
                                    <div className="col-md-3">
                                        <div className="form-group">
                                            <input type="text" className="form-control" placeholder="Username Telegram" name="userTele" required onChange={e => this.props.setField(e)} />
                                        </div>
                                    </div>
                                    <div className="col-md-3">
                                        <div className="form-group">
                                ...
                                <div className="col-12 register text-center">
                                    <button type="submit" className="btn btn-success mb-3" onClick={() => this.doRegisterUser()}>Register</button><br />
                                    <span style={{ color: "#476678"}}>Sudah punya akun? Silahkan Login </span> <Link to="/login" style={{ color: "#476678", fontWeight:"600" }}>Disini</Link>
                                </div>
                                <div className="col-12 register text-center">
                                    <span style={{ color: "#476678"}}><i class="fas fa-question-circle"></i> Registrasi sebagai </span> <Link to="/regiscounselor" style={{ color: "#476678", fontWeight:"600" }}>Counselor</Link>
                                </div>
                            </form>
                        </div>
                    </div>
...
export default connect(
    "is_login, username, password", actions)(withRouter(RegisterUser));